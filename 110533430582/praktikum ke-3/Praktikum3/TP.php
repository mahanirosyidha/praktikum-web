...
*{font-family: Segoe UI, Tahoma; <!--jenis huruf-->
margin: auto;
padding:0;
...
#container{ 
	...
	width: 15%; 
	height: auto;
	padding: 10px; <!--jarak antara content dan norder-->
	border: 1px solid purple <!--batas luar elemen-->
}
...
if ((username==null || username=="")||(pass==null|| pass=="")) //pernyataan kondisi jika username dan password kosong
  {
  ...
  if(cekhuruf(username)=== false ||cekhuruf(pass)===false) //pernyataan kondisi jika pengisian pada username dan password terdapat inputan angka
  {
...
if (isset($_POST['submit'])) { 
	if ((isset($_POST['username'])&&$_POST['username']=='mahani')&&(isset($_POST['pass'])&&$_POST['pass']=='mahani')) {
